...
This adapts :meth:`mira.data.RocketLeagueDataset.iter_clips` (the streaming read path) into
...
from .dataset import RocketLeagueDataset
...
class _VideoActionIterable(IterableDataset):
    ...
    def _my_shards(self, dataset: RocketLeagueDataset) -> list[str]:
    ...
    def _shard_view(self, dataset: RocketLeagueDataset, shard: str) -> RocketLeagueDataset:
    ...
    def _groups(self, dataset: RocketLeagueDataset, shard: str) -> Iterator[list[dict[str, Any]]]:
    ...
    def __iter__(self) -> Iterator[dict[str, Any]]:
        ...
        dataset = RocketLeagueDataset.from_local(self.index_path, vocab=self.vocab)
...
def create_loader(
    ...
    *,
    ...
    probe = RocketLeagueDataset.from_local(index_path, vocab=KeyVocab(tuple(action_config.valid_keys)))
